...
This module is a vendored and adapted fork of the excellent library `Arcsecond`,
by francisrstokes (https://github.com/francisrstokes/arcsecond).
The original source code is borrowed under the terms of the MIT license.

This fork removes support for UintArray and TypedArray, using raw JS strings instead.
Henceforth it's much faster for our usecases (by a factor of ~35x).
...
export type { ParserState, ResultType, Err, Ok };

export { updateData, Parser, updateError, updateParserState, updateResult };
...
export function pipeParsers<A, B, C, D, E, F, G, H>([p1, p2, p3, p4, p5, p6, p7, p8]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I>([p1, p2, p3, p4, p5, p6, p7, p8, p9]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K, L>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G>([p1, p2, p3, p4, p5, p6, p7]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G, H>([p1, p2, p3, p4, p5, p6, p7, p8]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G, H, I>([p1, p2, p3, p4, p5, p6, p7, p8, p9]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function parse<T, E, D>(parser: Parser<T, E, D>): (target: string) => ResultType<T, E, D> {
	...
	return new Parser(function many$state(state) {
		...
		while (true) {
			...
			if (out.isError) {
				...
				if (nextState.index > nextState.source.length - 1) break;
			}
		}
...
export const char = function char(c: string): Parser<string> {
	if (!c || c.length !== 1) throw new TypeError(`char must be called with a single character, but got ${c}`);
...
export const anyChar: Parser<string> = new Parser(function anyChar$state(state) {
	...
	if (index > source.length - 1)
		return updateError(state, `ParseError (position ${index}): Expecting any character, but got end of input.`);

	const char = source[index];
	return updateParserState(state, char, index + 1);
});
...
export const peek: Parser<string> = new Parser(function peek$state(state) {
	...
	return updateParserState(state, source[index], index);
});

// str :: String -> Parser e String s
export function str(s: string): Parser<string> {
	if (!s || s.length < 1) throw new TypeError(`str must be called with a string with length > 1, but got ${s}`);
	...
	return new Parser(function str$state(state) {
		...
		const stringAtIndex = source.slice(index, index + s.length);
...
export const letter: Parser<string> = new Parser(function letter$state(state) {
	...
	const char = source[index];
	return char && reLetter.test(char)
		? updateParserState(state, char, index + 1)
...
// namedSeq :: [(String, Parser * * *)] -> Parser e (StrMap *) s
export function namedSeq(pairedParsers: Array<[string, Parser<any>]>): Parser<any[]> {
	return new Parser(function namedSeq$state(state) {
		if (state.isError) return state;
...
// seq :: [Parser * * *] -> Parser * [*] *
export function seq<A>([p1]: [Parser<A>]): Parser<[A]>;
export function seq<A, B>([p1, p2]: [Parser<A>, Parser<B>]): Parser<[A, B]>;
export function seq<A, B, C>([p1, p2, p3]: [Parser<A>, Parser<B>, Parser<C>]): Parser<[A, B, C]>;
export function seq<A, B, C, D>([p1, p2, p3, p4]: [Parser<A>, Parser<B>, Parser<C>, Parser<D>]): Parser<[A, B, C, D]>;
export function seq<A, B, C, D, E>([p1, p2, p3, p4, p5]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F>([p1, p2, p3, p4, p5, p6]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G>([p1, p2, p3, p4, p5, p6, p7]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H>([p1, p2, p3, p4, p5, p6, p7, p8]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I>([p1, p2, p3, p4, p5, p6, p7, p8, p9]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I, J>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I, J, K>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I, J, K, L>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I, J, K, L, M>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function seq<A, B, C, D, E, F, G, H, I, J, K, L, M, N>([
	p1,
	p2,
	p3,
	p4,
...
export function seq<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>([
	p1,
	p2,
	p3,
	p4,
...
export function choice<A, B, C, D>([p1, p2, p3, p4]: [Parser<A>, Parser<B>, Parser<C>, Parser<D>]): Parser<
	A | B | C | D
>;
...
export function choice<A, B, C, D, E, F, G, H, I, J, K>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function choice<A, B, C, D, E, F, G, H, I, J, K, L>([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12]: [
	Parser<A>,
	Parser<B>,
	Parser<C>,
	Parser<D>,
...
export function between<L, T, R>(leftParser: Parser<L>): (rightParser: Parser<R>) => (parser: Parser<T>) => Parser<T> {
	return function between$rightParser(rightParser) {
		return function between$parser(parser) {
			return seq([leftParser, parser, rightParser]).map(([_, x]) => x);
		};
	};
}
...
export const everyCharUntil = (parser: Parser<any>) => {
	return new Parser(state => {
		...
		return updateResult(nextState, result);
	});
};
...
// recursive :: (() => Parser e a s) -> Parser e a s
export function recursive<T, E, D>(parserThunk: () => Parser<T, E, D>): Parser<T, E, D> {
	return new Parser(function recursive$state(state) {
